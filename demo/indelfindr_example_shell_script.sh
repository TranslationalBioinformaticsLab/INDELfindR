...
#table_annovar.pl $dir/${vcf_prefix}.indelfindr.vcf {your-path}/annovar/humandb -buildver hg38 -out $dir/${vcf_prefix}.indelfindr -remove -protocol refGene,avsnp150,clinvar_20210501,cosmic94_coding -operation g,f,f,f -nastring . -polish -vcfinput
