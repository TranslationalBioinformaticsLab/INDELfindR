...
#############################################################################################
# #
# bamPath <- "/Users/George/indel_detection_tool_project/last_dev/subset_Control_common.sorted.bam"
...
# target_regions <- F
# #target_regions <-"/Users/George/indel_detection_tool_project/last_dev/subset_last_dev_regions.txt"
